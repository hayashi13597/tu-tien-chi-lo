...
function pill(id: string, over: Partial<PillRecord>): PillRecord {
  return { id, name: id, glyph: 'x', rarity: 0, tier: 1, effectKind: 'linhKhi', amount: null, multiplier: null, durationSec: null, bonusPct: null, desc: '', active: true, starterQuantity: 0, ...over };
}
