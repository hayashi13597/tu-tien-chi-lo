...
function pill(id: string, over: Partial<PillRecord> = {}): PillRecord {
  return { id, name: id, glyph: 'x', rarity: 0, tier: 1, effectKind: 'linhKhi', amount: 10, multiplier: null, durationSec: null, bonusPct: null, combatAttribute: null, combatTrigger: null, desc: 'd', active: true, starterQuantity: 0, ...over };
}
